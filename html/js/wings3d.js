...
const action = {
   ...
   createTorus: () => {notImplemented(this);},
   ...
   createSpring: () => {notImplemented(this);},
   createSpringPref: () => {notImplemented(this);},
   createTetrahedron: () => {notImplemented(this);},
   createTetrahedronPref: () => {notImplemented(this);},
   createOctahedron: () => {notImplemented(this);},
   createOctahedronPref: () => {notImplemented(this);},
   createOctotoad: () => {notImplemented(this);},
   createOctotoadPref: () => {notImplemented(this);},
   createDodecahedron: () => {notImplemented(this);},
   createDodecahedronPref: () => {notImplemented(this);},
