...
PreviewCage.findWeldContours = function(overlap) {
   ...
   const edgeLoops = __WEBPACK_IMPORTED_MODULE_2__wings3d_wingededge__["WingedTopology"].findContours(overlap.merged);
...
PreviewCage.weldableFace = function(target, compare, tolerance) {
   ...
   const sqrLen = vec3.sqrDist(target.center, compare.center);
   if (sqrLen > toleranceSquare) {
      return false;
   }
...
class EdgeMadsor extends __WEBPACK_IMPORTED_MODULE_0__wings3d_mads__["Madsor"] {
   constructor() {
      ...
      // Dissolve
      __WEBPACK_IMPORTED_MODULE_6__wings3d_ui__["bindMenuItem"](__WEBPACK_IMPORTED_MODULE_9__wings3d__["action"].edgeDissolve.name, function(ev) {
...
class BodyMadsor extends __WEBPACK_IMPORTED_MODULE_0__wings3d_mads__["Madsor"] {
   constructor() {
      super('body');
      const self = this;
      __WEBPACK_IMPORTED_MODULE_8__wings3d_ui__["bindMenuItem"](__WEBPACK_IMPORTED_MODULE_10__wings3d__["action"].bodyDelete.name, function(ev) {
   ...
   weld(tolerance = 0.001) {
      ...
      if (weldContours !== false) {
         ...
         const holes = __WEBPACK_IMPORTED_MODULE_5__wings3d_model__["PreviewCage"].weldHoles(merged);
...
class VertexMadsor extends __WEBPACK_IMPORTED_MODULE_0__wings3d_mads__["Madsor"] {
   constructor() {
      ...
      __WEBPACK_IMPORTED_MODULE_8__wings3d_ui__["bindMenuItem"](__WEBPACK_IMPORTED_MODULE_9__wings3d__["action"].vertexCollapse.name, function(ev) {
